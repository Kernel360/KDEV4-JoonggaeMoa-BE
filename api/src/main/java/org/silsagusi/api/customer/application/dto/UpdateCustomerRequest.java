...
public class UpdateCustomerRequest {
	...
	public UpdateCustomerCommand toCommand(Customer customer) {
		return new UpdateCustomerCommand(customer, name, birthday, phone, email, job, isVip, memo, consent,
			interestProperty, interestLocation, assetStatus);
	}
}

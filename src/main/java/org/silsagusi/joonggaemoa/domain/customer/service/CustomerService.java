...
public class CustomerService {
    ...
    public void updateCustomer(
        ...
        customer.updateCustomer(
            (customerRequestDto.getName() == null || customerRequestDto.getName().isBlank()) ? customer.getName() : customerRequestDto.getName(),
            (customerRequestDto.getBirthday() == null) ? customer.getBirthday() : customerRequestDto.getBirthday(),
            (customerRequestDto.getPhone() == null || customerRequestDto.getPhone().isBlank()) ? customer.getPhone() : customerRequestDto.getPhone(),
            (customerRequestDto.getEmail() == null || customerRequestDto.getEmail().isBlank()) ? customer.getEmail() : customerRequestDto.getEmail(),
            (customerRequestDto.getJob() == null || customerRequestDto.getJob().isBlank()) ? customer.getJob() : customerRequestDto.getJob(),
            (customerRequestDto.getIsVip() == null) ? customer.getIsVip() : customerRequestDto.getIsVip(),
            (customerRequestDto.getMemo() == null || customerRequestDto.getMemo().isBlank()) ? customer.getMemo() : customerRequestDto.getMemo(),

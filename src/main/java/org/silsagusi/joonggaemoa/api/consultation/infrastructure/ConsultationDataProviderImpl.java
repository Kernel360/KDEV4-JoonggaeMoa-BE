...
public class ConsultationDataProviderImpl implements ConsultationDataProvider {
    ...
    public void updateConcsultation(
        ...
        consultation.updateConsultation(
            ...
            (interestProperty == null || interestProperty.isBlank()) ? consultation.getInterestProperty() : interestProperty,
            (interestLocation == null || interestLocation.isBlank()) ? consultation.getInterestLocation() : interestLocation,
            ...
            (consultationStatus == null) ? consultation.getConsultationStatus() : ConsultationStatus.valueOf(consultationStatus)
        );
        consultationRepository.save(consultation);
    }
    ...
    public List<Consultation> getConsultationByDate(Long agentId, LocalDateTime date) {
        ...
        List<Consultation> consultationList = consultationRepository.findAllByCustomer_AgentIdAndDateBetween(agentId, startOfDay, endOfDay);
